 ...
 */
exports.DEFAULT_OPENAI_REALTIME_MODEL = 'gpt-4o-realtime-preview';
/**
...
class OpenAIRealtimeBase extends utils_2.EventEmitterDelegate {
    ...
    _getMergedSessionConfig(config) {
        const sessionData = {
            ...
            model: config.model ??
                this.#model ??
                exports.DEFAULT_OPENAI_REALTIME_SESSION_CONFIG.model,
            voice: config.voice ?? exports.DEFAULT_OPENAI_REALTIME_SESSION_CONFIG.voice,
            speed: config.speed ?? exports.DEFAULT_OPENAI_REALTIME_SESSION_CONFIG.speed,
            modalities: config.modalities ?? exports.DEFAULT_OPENAI_REALTIME_SESSION_CONFIG.modalities,
            input_audio_format: config.inputAudioFormat ??
                exports.DEFAULT_OPENAI_REALTIME_SESSION_CONFIG.inputAudioFormat,
            output_audio_format: config.outputAudioFormat ??
                exports.DEFAULT_OPENAI_REALTIME_SESSION_CONFIG.outputAudioFormat,
            input_audio_transcription: config.inputAudioTranscription ??
                exports.DEFAULT_OPENAI_REALTIME_SESSION_CONFIG.inputAudioTranscription,
            input_audio_noise_reduction: config.inputAudioNoiseReduction ??
                exports.DEFAULT_OPENAI_REALTIME_SESSION_CONFIG.inputAudioNoiseReduction,
            turn_detection: OpenAIRealtimeBase.buildTurnDetectionConfig(config.turnDetection) ??
                exports.DEFAULT_OPENAI_REALTIME_SESSION_CONFIG.turnDetection,
            tool_choice: config.toolChoice ?? exports.DEFAULT_OPENAI_REALTIME_SESSION_CONFIG.toolChoice,
