...
class OpenAIRealtimeWebRTC extends openaiRealtimeBase_1.OpenAIRealtimeBase {
    ...
    async connect(options) {
        ...
        if ((0, _shims_1.isBrowserEnvironment)() && !this.#useInsecureApiKey && !isClientKey) {
            throw new agents_core_1.UserError('Using the WebRTC connection in a browser environment requires an insecure API key. Please use a WebSocket connection instead or set the useInsecureApiKey option to true.');
        }
